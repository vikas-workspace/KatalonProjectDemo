...
// WebUI is class in katalon studio which contains all webUI keywords.
// Using this class WebUI we can assces the all methods or all the keywords 


// 1. Login Orange HRM portal 
WebUI.openBrowser('')
